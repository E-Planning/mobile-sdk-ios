...
@protocol EPLInterstitialAdViewControllerDelegate;
@class EPLMRAIDOrientationProperties;

@interface EPLInterstitialAdViewController : UIViewController

@property (nonatomic, readwrite, weak) id<EPLInterstitialAdViewControllerDelegate> delegate;
...
@protocol EPLInterstitialAdViewControllerDelegate <NSObject>
