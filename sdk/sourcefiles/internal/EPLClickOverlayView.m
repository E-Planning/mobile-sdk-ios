...
@interface EPLClickOverlayView ()

@end

@implementation EPLClickOverlayView
...
+ (EPLClickOverlayView *)addOverlayToView:(UIView *)view {
    EPLClickOverlayView *overlay = [[EPLClickOverlayView alloc] init];
...
- (UIColor *)colorForColorOption:(EPLClickOverlayColorOption)option withAlpha:(CGFloat)alpha {
    switch (option) {
        case EPLClickOverlayColorOptionRed:
            return [UIColor colorWithRed:163.0/255.0
                                   green:48.0/255.0
                                    blue:53.0/255.0
                                   alpha:alpha];
        case EPLClickOverlayColorOptionTeal:
            return [UIColor colorWithRed:0.0/255.0
                                   green:197.0/255.0
                                    blue:181.0/255.0
                                   alpha:alpha];
        default: // case EPLClickOverlayColorOptionGrey
...
- (void)drawRect:(CGRect)rect {
    UIBezierPath *roundedRect = [UIBezierPath bezierPathWithRoundedRect:self.bounds
                                                           cornerRadius:2.0];
    UIColor *bkColor = [self colorForColorOption:EPLCLICKOVERLAYCOLOROPTION
                                       withAlpha:0.8];
    [bkColor setFill];
