...
@interface EPLLocation : NSObject
...
/**
 Returns an EPLLocation instance generated from a user's location. It is
...
/**
 Returns an EPLLocation instance with latitude and longitude values rounded to the
