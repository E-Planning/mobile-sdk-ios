...
@interface EPLAdResponseInfo : NSObject
/**
 ...
 */
@property (nonatomic, readwrite)  EPLAdType  adType;
 ...
 */
@property (nonatomic, readwrite, strong, nullable) EPLDSAResponseInfo *dsaResponseInfo;
