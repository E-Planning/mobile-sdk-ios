...
typedef NS_ENUM(NSUInteger, EPLInitialAudioSetting) {
    SoundOn,
    SoundOff,
    Default
};
 ...
 */
@interface EPLVideoPlayerSettings : NSObject
...
@property (nonatomic,assign) EPLInitialAudioSetting initalAudio;
