...
@protocol EPLMRAIDExpandViewControllerDelegate;
...
@interface EPLMRAIDExpandViewController : UIViewController

- (instancetype)initWithContentView:(UIView *)contentView
                   expandProperties:(EPLMRAIDExpandProperties *)expandProperties;
- (UIView *)detachContentView;

@property (nonatomic, readwrite, weak) id<EPLMRAIDExpandViewControllerDelegate> delegate;
@property (nonatomic, readwrite, strong) EPLMRAIDOrientationProperties *orientationProperties;

@end

@protocol EPLMRAIDExpandViewControllerDelegate <NSObject>
