 ...
 * */
typedef NS_ENUM(NSUInteger, EPLUserIdSource)  {
    EPLUserIdSourceLiveRamp,
    EPLUserIdSourceNetId,
    EPLUserIdSourceCriteo,
    EPLUserIdSourceTheTradeDesk,
    EPLUserIdSourceUID2
};
...
/**
 ...
 @param source for Source of the  User Id as per EPLUserIdSource Enum
 @param userId for The User Id String
 */

- (nullable instancetype)initWithANUserIdSource:(EPLUserIdSource)source userId:(nonnull NSString *)userId;
