...
@implementation EPLUniversalTagAdServerResponse

#pragma mark Inject creative content.

+ (nullable EPLRTBVideoAd *)generateRTBVideoAdUnitFromVASTObject: (nonnull NSString *)vastContent
                                                          width: (NSInteger)width
                                                         height: (NSInteger)height
{
    EPLRTBVideoAd  *rtbVideoAd  = [[EPLRTBVideoAd alloc] init];
...
+ (nullable EPLStandardAd *)generateStandardAdUnitFromHTMLContent: (nonnull NSString *)htmlContent
                                                           width: (NSInteger)width
                                                          height: (NSInteger)height
{
    EPLStandardAd  *standardAd  = [[EPLStandardAd alloc] init];
...
+ (nullable NSArray<NSDictionary<NSString *, id> *> *)generateTagsFromResponseData:(nullable NSData *)data
{
    ...
    if (!jsonResponse) {
        EPLLogError(@"FAILED to acquire JSON response from data.");
        return  nil;
    }

    EPLLogDebug(@"jsonResponse=%@", [jsonResponse description]);

    if (! [jsonResponse[kANUniversalTagAdServerResponseKeyTags] isKindOfClass:[NSArray class]]) {
        EPLLogError(@"FAILED to find an array of tags in UT Reponse data.");
        return  nil;
    }
...
+ (nonnull NSMutableArray<id> *)generateAdObjectInstanceFromJSONAdServerResponseTag:(nonnull NSDictionary<NSString *, id> *)tag
{
    ...
    for (id adObject in arrayOfJSONAdObjects)
    {
        ...
        if (!contentSource && !adType) {
            EPLLogError(@"Response from ad server in an unexpected format content_source/ad_type UNDEFINED.  (adObject=%@)", adObject);
            continue;
        }
        ...
        NSDictionary *dsaObject = adObject[kANUniversalTagAdServerResponseKeyAdsDSA];
         ...
         adResponseInfo.adType = [EPLGlobal adTypeStringToEnum:adType];
         ...
         adResponseInfo.publisherCurrencyCode = publisherCurrencyCode;
         adResponseInfo.dsaResponseInfo = [EPLDSAResponseInfo dsaObjectFromAdObject: dsaObject];
        
#if !APPNEXUS_NATIVE_MACOS_SDK
        EPLVerificationScriptResource *omidVerificationScriptResource;
        ...
        if ([contentSource isEqualToString:kANUniversalTagAdServerResponseKeyAdsRTBObject])
        {
            ...
            if (rtbObject) {
                ...
                if ([adType isEqualToString:kANUniversalTagAdServerResponseKeyBannerObject]) {
                    EPLStandardAd *standardAd = [[self class] standardAdFromRTBObject:rtbObject];
                    if (standardAd) {
                ...
                // RTB - Video
                    ...
                    EPLRTBVideoAd *videoAd = [[self class] videoAdFromRTBObject:rtbObject];
                    if (videoAd) {
                ...
                // RTB - Native
                    ...
                    EPLNativeStandardAdResponse  *nativeAd  = [[self class] nativeAdFromRTBObject:rtbObject];
                    if (nativeAd) {
                        nativeAd.creativeId = creativeId;
                        nativeAd.adResponseInfo = adResponseInfo;
                        // Set Impression Type for NativeAd
                        if([EPLAd.sharedInstance isEligibleForViewableImpression:adResponseInfo.memberId]){
                            nativeAd.impressionType = EPLViewableImpression;
                        }
                    ...
                    EPLLogError(@"UNRECOGNIZED AD_TYPE in RTB.  (adType=%@  rtbObject=%@)", adType, rtbObject);
                }
            }
        ...
        // CSM
            ...
            if([adType isEqualToString:kANUniversalTagAdServerResponseKeyBannerObject] || [adType isEqualToString:kANUniversalTagAdServerResponseKeyNativeObject]){
                ...
                if (csmObject) {
                    EPLMediatedAd *mediatedAd = [[self class] mediatedAdFromCSMObject:csmObject];
                    if (mediatedAd) {
                        if ([adType isEqualToString:kANUniversalTagAdServerResponseKeyNativeObject]) {
                ...
                EPLCSMVideoAd *csmVideoAd = [[self class] videoCSMAdFromCSMObject:adObject withTagObject:tag];
                if(csmVideoAd){
                    [arrayOfAdUnits addObject:csmVideoAd];
                }
            }else{
                EPLLogError(@"UNRECOGNIZED AD_TYPE in CSM.  (adObject=%@)", adObject);
            }
        // CSR - Only for Facebook Native Banner is supported by CSR
            ...
            if([adType isEqualToString:kANUniversalTagAdServerResponseKeyNativeObject]){
                            ...
                            if (csrObject) {
                                EPLCSRAd *csrAd = [[self class] mediatedAdFromCSRObject:csrObject];
                                if (csrAd) {
                                    // Parsing viewability object to create measurement resources for OMID Native integration
                                    if(omidVerificationScriptResource != nil){
                ...
                EPLLogError(@"UNRECOGNIZED AD_TYPE in CSR.  (adObject=%@)", adObject);
            }
        // SSM - Only Banner and Interstitial are supported in SSM
            ...
            if([adType isEqualToString:kANUniversalTagAdServerResponseKeyBannerObject]){
                ...
                if (ssmObject) {
                    EPLSSMStandardAd *ssmStandardAd = [[self class] standardSSMAdFromSSMObject:ssmObject];
                    if (ssmStandardAd) {
                ...
                EPLLogError(@"UNRECOGNIZED AD_TYPE in SSM.  (adObject=%@)", adObject);
            }
        }else{
            EPLLogError(@"UNRECOGNIZED adObject.  (adObject=%@)", adObject);
        }
        ...
        if ([lastAdsObject isKindOfClass:[EPLBaseAdObject class]]) {
            EPLBaseAdObject  *baseAdObject  = (EPLBaseAdObject *)lastAdsObject;
            baseAdObject.adType = [adType copy];
            baseAdObject.adResponseInfo = adResponseInfo;
            // Set Impression Type for this AdObject
            if([EPLAd.sharedInstance isEligibleForViewableImpression:adResponseInfo.memberId]){
                baseAdObject.impressionType = EPLViewableImpression;
            }
        }
    }
...
+ (NSArray *)adsArrayFromTag:(NSDictionary *)tag {
    if ([tag[kANUniversalTagAdServerResponseKeyTagAds] isKindOfClass:[NSArray class]]) {
        ...
        EPLLogError(@"Response from ad server in an unexpected format no ads array found in tag: %@", tag);
        return nil;
    }
}
#if !APPNEXUS_NATIVE_MACOS_SDK
+ (EPLVerificationScriptResource *)anVerificationScriptFromAdObject:(NSDictionary *)adObject {
    if ([adObject[kANUniversalTagAdServerResponseKeyViewabilityObject] isKindOfClass:[NSDictionary class]]) {
        ...
        EPLVerificationScriptResource *verificationScriptResource = [[EPLVerificationScriptResource alloc] init];
        [verificationScriptResource anVerificationScriptResource:viewabilityObject];
        return verificationScriptResource;
    }else{
        EPLLogError(@"Response from ad server in an unexpected format. Expected Viewability in adObject: %@", adObject);
        return nil;
    }
}
#endif
...
+ (NSDictionary *)rtbObjectFromAdObject:(NSDictionary *)adObject {
    if ([adObject[kANUniversalTagAdServerResponseKeyAdsRTBObject] isKindOfClass:[NSDictionary class]]) {
        ...
        EPLLogError(@"Response from ad server in an unexpected format. Expected RTB in adObject: %@", adObject);
        return nil;
    }
}
...
+ (NSDictionary *)csmObjectFromAdObject:(NSDictionary *)adObject {
    if ([adObject[kANUniversalTagAdServerResponseKeyAdsCSMObject] isKindOfClass:[NSDictionary class]]) {
        ...
        EPLLogError(@"Response from ad server in an unexpected format. Expected CSM in adObject: %@", adObject);
        return nil;
    }
}
...
+ (NSDictionary *)ssmObjectFromAdObject:(NSDictionary *)adObject {
    if ([adObject[kANUniversalTagAdServerResponseKeyAdsSSMObject] isKindOfClass:[NSDictionary class]]) {
        ...
        EPLLogError(@"Response from ad server in an unexpected format. Expected SSM in rtbObject: %@", adObject);
        return nil;
    }
}
...
+ (NSDictionary *)csrObjectFromAdObject:(NSDictionary *)adObject {
    if ([adObject[kANUniversalTagAdServerResponseKeyAdsCSRObject] isKindOfClass:[NSDictionary class]]) {
        ...
        EPLLogError(@"Response from ad server in an unexpected format. Expected CSR in adObject: %@", adObject);
        return nil;
    }
}

+ (EPLStandardAd *)standardAdFromRTBObject:(NSDictionary *)rtbObject
{
    if ([rtbObject[kANUniversalTagAdServerResponseKeyBannerObject] isKindOfClass:[NSDictionary class]])
    {
        ...
        EPLLogError(@"Response from ad server in an unexpected format. Expected RTB Banner in rtbObject: %@", rtbObject);
        return nil;
    }
}

+ (EPLRTBVideoAd *)videoAdFromRTBObject:(NSDictionary *)rtbObject
{
    if (! [rtbObject[kANUniversalTagAdServerResponseKeyVideoObject] isKindOfClass:[NSDictionary class]])
    {
        EPLLogError(@"Response from ad server in an unexpected format.  Expected RTB Video in rtbObject: %@", rtbObject);
        return nil;
    }

    NSDictionary  *videoAdObjectDictionary  = rtbObject[kANUniversalTagAdServerResponseKeyVideoObject];
    EPLRTBVideoAd  *videoAd                  = [[EPLRTBVideoAd alloc] init];
...
+ (EPLMediatedAd *)mediatedAdFromCSMObject:(NSDictionary *)csmObject
{
    if ([csmObject[kANUniversalTagAdServerResponseKeyHandler] isKindOfClass:[NSArray class]])
    {
        EPLMediatedAd  *mediatedAd    = nil;
        ...
        for (id handlerObject in handlerArray)
        {
            if ([handlerObject isKindOfClass:[NSDictionary class]])
            {
                ...
                if ([type.lowercaseString isEqualToString:kANUniversalTagAdServerResponseValueIOS])
                {
                    ...
                    mediatedAd = [[EPLMediatedAd alloc] init];
                    ...
                    EPLLogDebug(@"adId = %@", mediatedAd.adId);
                    ...
                    EPLLogError(@"UNRECOGNIZED CSM type.  (%@)", type);
                }
            }
    ...
    EPLLogError(@"Response from ad server in an unexpected format. Expected CSM in csmObject: %@", csmObject);
    return nil;
}

+(EPLCSMVideoAd *)videoCSMAdFromCSMObject:(id) csmObject withTagObject:(NSDictionary *)tagDictionary{
    ...
    EPLCSMVideoAd *videoAd = [[EPLCSMVideoAd alloc] init];
    videoAd.adDictionary = newTagDictionary;
    return videoAd;
}

+ (EPLSSMStandardAd *)standardSSMAdFromSSMObject:(NSDictionary *)ssmObject {
    if ([ssmObject[kANUniversalTagAdServerResponseKeyBannerObject] isKindOfClass:[NSDictionary class]])
    {
        ...
        if ([ssmObject[kANUniversalTagAdServerResponseKeyHandler] isKindOfClass:[NSArray class]])
        {
            ...
            if ([[handlerArray firstObject] isKindOfClass:[NSDictionary class]])
            {
                ...
                EPLSSMStandardAd *standardAd = [[EPLSSMStandardAd alloc] init];
    ...
    EPLLogError(@"Response from ad server in an unexpected format. Unable to find SSM Banner in ssmObject: %@", ssmObject);
    return nil;
}
#if !APPNEXUS_NATIVE_MACOS_SDK
+ (EPLCSRAd *)mediatedAdFromCSRObject:(NSDictionary *)csrObject
{
        ...
        for (id handlerObject in handlerArray)
        {
            if ([handlerObject isKindOfClass:[NSDictionary class]])
            {
                ...
                if ([type.lowercaseString isEqualToString:kANUniversalTagAdServerResponseValueIOS])
                {
                    ...
                    EPLLogError(@"UNRECOGNIZED CSR type.  (%@)", type);
                }
            }
        } //endfor -- handlerObject
    ...
    EPLLogError(@"Response from ad server in an unexpected format. Expected CSM in csmObject: %@", csrObject);
    return nil;
}
#endif
...
+ (EPLNativeStandardAdResponse *)nativeAdFromRTBObject:(NSDictionary *)nativeObject
{
    if (!nativeObject) {
        EPLLogError(@"nativeRTBObject is nil");
        return nil;
    }
    
    if (! [nativeObject[kANUniversalTagAdServerResponseKeyNativeObject] isKindOfClass:[NSDictionary class]]) {
        EPLLogDebug(@"Response from ad server in an unexpected format. Unable to find RTB native in nativeObject: %@", nativeObject);
        return nil;
    }
    NSDictionary *nativeRTBObject = nativeObject[kANUniversalTagAdServerResponseKeyNativeObject];
    
    if(nativeRTBObject == nil){
        EPLLogDebug(@"Response from ad server in an unexpected format. Unable to find RTB native in nativeContentFromRTBObject: %@", nativeRTBObject);
        return nil;
    }
    
    if([nativeRTBObject isKindOfClass:[NSDictionary class]]){
        EPLNativeStandardAdResponse *nativeAd = [[EPLNativeStandardAdResponse alloc] init];
        ...
        if ([nativeRTBObject[kANUniversalTagAdServerResponseKeyNativeRatingDict] isKindOfClass:[NSString class]]) {
            ...
            nativeAd.rating = [[EPLNativeAdStarRating alloc] initWithValue:[rating floatValue]
    ...
    {
        EPLLogDebug(@"Response from ad server in an unexpected format. Unable to find RTB native in nativeRTBObject: %@", nativeRTBObject);
        return nil;
    }
}
...
+ (nullable NSDictionary<NSString *, id> *)generateDictionaryFromJSONResponse:(NSData *)data
{
    ...
    if (!responseString || ([responseString length] <= 0)) {
        EPLLogDebug(@"Received empty response from ad server");
        return nil;
    }
    ...
    if (jsonParsingError) {
        EPLLogError(@"response_json_error %@", jsonParsingError);
        return nil;

    } else if (![responseDictionary isKindOfClass:[NSDictionary class]]) {
        EPLLogError(@"Response from ad server in an unexpected format: %@", responseDictionary);
        return nil;
    }
