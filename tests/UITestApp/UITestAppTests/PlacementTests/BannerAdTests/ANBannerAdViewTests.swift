...
class ANBannerAdViewTests: XCTestCase, ANBannerAdViewDelegate {
    ...
    func testRTBBanner320x50() {
        ...
        let adObject = AdObject(adType: "Banner", accessibilityIdentifier: PlacementTestConstants.BannerAd.testRTBBanner320x50, placement: "16392991")
    ...
    func testRTBBanner300x250() {
        ...
        let adObject = AdObject(adType: "Banner", accessibilityIdentifier: PlacementTestConstants.BannerAd.testRTBBanner300x250, placement: "16392991")
