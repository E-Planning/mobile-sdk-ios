...
/**
 ...
 Example Usage:
 @code
 // Create an instance of EPLDSASettings
 [EPLDSASettings.sharedInstance setDsaRequired:1];
 [EPLDSASettings.sharedInstance setPubRender:0];
 // [EPLDSASettings.sharedInstance setDataToPub:1];

 // Create a list of transparency info
 NSMutableArray<EPLDSATransparencyInfo *> *transparencyList = [NSMutableArray array];
 [transparencyList addObject:[[EPLDSATransparencyInfo alloc] initWithDomain:@"example.com" andDSAParams:@[@1, @2, @3]]];
 [transparencyList addObject:[[EPLDSATransparencyInfo alloc] initWithDomain:@"example.net" andDSAParams:@[@4, @5, @6]]];

 // Set the transparency list in EPLDSASettings
 [EPLDSASettings.sharedInstance setTransparencyList:transparencyList];
 @endcode
*/
@interface EPLDSASettings : NSObject
...
/**
 * Set the transparency list using the provided list of EPLDSATransparencyInfo.
 */
@property (nonatomic, strong, nullable) NSArray<EPLDSATransparencyInfo *> *transparencyList;
