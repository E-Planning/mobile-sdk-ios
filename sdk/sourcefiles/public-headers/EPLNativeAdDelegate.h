...
@class EPLNativeAdResponse;

/*!
 * Defines all the callbacks for a native view registered
 * with an EPLNativeAdResponse.
 */
@protocol EPLNativeAdDelegate <NSObject>  
 ...
 * native browser instead, then set clickThroughAction to EPLClickThroughActionOpenDeviceBrowser.
 */
