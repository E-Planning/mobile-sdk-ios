...
/**
 ...
 for (EPLDSATransparencyInfo *transparencyInfo in adResponseInfo.dsaResponseInfo.transparencyList) {
 ...
 @endcode
 */
@interface EPLDSAResponseInfo : NSObject
 ...
 */
@property (nonatomic, strong, nullable) NSMutableArray<EPLDSATransparencyInfo *> *transparencyList;
