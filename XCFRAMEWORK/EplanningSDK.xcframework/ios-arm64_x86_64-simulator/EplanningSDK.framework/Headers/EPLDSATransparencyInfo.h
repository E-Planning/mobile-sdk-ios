...
Example Usage:
@code
// Create an instance of EPLDSATransparencyInfo
EPLDSATransparencyInfo *transparency = [[EPLDSATransparencyInfo alloc] initWithDomain:@"example.com" andDSAParams:@[@1, @2, @3]];
...
@endcode
*/
@interface EPLDSATransparencyInfo : NSObject
...
/**
 * Initializes an EPLDSATransparencyInfo instance with the specified domain and DSA params.
*/
