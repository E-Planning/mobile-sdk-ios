...
@implementation EPLMRAIDExpandProperties

+ (EPLMRAIDExpandProperties *)expandPropertiesFromQueryComponents:(NSDictionary *)queryComponents {
    ...
    return [[EPLMRAIDExpandProperties alloc] initWithWidth:w
                                                   height:h
                                                      URL:URL
