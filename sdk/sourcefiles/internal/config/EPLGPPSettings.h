...
@interface EPLGPPSettings : NSObject

/**
 * Get the IAB Gpp  String in the SDK.
 * Check for EPL_IABGPP_HDR_GppString and return if present else return @""
 */
+ (nonnull NSString *) getGPPString;

/**
 * Get the IAB Gpp Section ID(s) considered to be in force.
 * Check for EPL_IABGPP_GppSID and return if present else return @""
 */
