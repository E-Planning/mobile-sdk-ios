/*   Copyright 2013 APPNEXUS INC
 ...
 WITHOUT WARRANTIES OR CONDITIONS OF ANYY KIND, either express or implied.
...
#pragma mark - EPLAdProtocol partitions.
/**
 EPLAdProtocol defines the properties and methods that are common to *all* ad types.
...
@protocol EPLAdProtocolFoundationCore <NSObject>
...
/**
 The user's location.  See EPLLocation.h in this directory for
 details.
 */
...
/**
 The user's gender.  See the EPLGender enumeration in EPLAdConstants.h for details.
 */
...
@end   //EPLAdProtocolFoundationCore



#pragma mark -

@protocol EPLAdProtocolFoundation <EPLAdProtocolFoundationCore>
...
@end   //EPLAdProtocolFoundation



#pragma mark -

@protocol EPLAdProtocolBrowser
 ...
 */
@property (nonatomic, readwrite)  EPLClickThroughAction  clickThroughAction;
...
/**
 ...
 Only used when clickThroughAction is set to EPLClickThroughActionOpenSDKBrowser.
 */
@property (nonatomic, readwrite, assign) BOOL landingPageLoadsInBackground;

@end   //EPLAdProtocolBrowser
...
@protocol EPLAdProtocolPublicServiceAnnouncement
...
@end   //EPLAdProtocolPublicServiceAnnouncement



#pragma mark - EPLAdProtocol adunit combinations.

@protocol EPLAdProtocol <EPLAdProtocolFoundation, EPLAdProtocolBrowser, EPLAdProtocolPublicServiceAnnouncement>

/**
 * An AppNexus Single Unified object that will contain all the common fields of all the ads types
 *
 * adResponseInfo should be accessible from response Object only -- EPLBannerAdView, EPLInterstitialAd, EPLInstreamVideoAd and EPLNativeAdResponse).
 * It is placed into EPLAdProtocol instead of EPLAdProtocolFoundation to avoid adResponseInfo being accessed through EPLNativeAdRequest.
 */
...
@protocol EPLNativeAdRequestProtocol <EPLAdProtocolFoundation, EPLAdProtocolPublicServiceAnnouncement>
    //EMPTY
@end

@protocol EPLNativeAdResponseProtocol <EPLAdProtocolBrowser>
    //EMPTY
@end



@protocol EPLVideoAdProtocol <EPLAdProtocol, EPLAdProtocolVideo>
/**
...
#pragma mark - EPLAdDelegate.

/**
 The definition of the `EPLAdDelegate' protocol includes methods which can be implemented by either type of ad.
 ...
 */
@protocol EPLAdDelegate <NSObject>
...
/**
 Sent when the ad content has been successfully retrieved from the server.
   ...
   ad:didReceivNativeAd:    used to receive EPLNativeAdReponse when that is returned from an EPLBannerAdView request.
 */
...
/**
 ...
 If you would prefer that ad clicks open the native browser instead,
   set clickThroughAction to EPLClickThroughActionOpenDeviceBrowser.
 */
...
/**
 ...
 This will happen in a number of cases, including when
   clickThroughAction is set to EPLClickThroughActionOpenDeviceBrowser.
 */
