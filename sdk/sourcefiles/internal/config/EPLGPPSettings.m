...
NSString * const  EPL_IABGPP_HDR_GppString = @"IABGPP_HDR_GppString";
NSString * const  EPL_IABGPP_GppSID = @"IABGPP_GppSID";

@implementation EPLGPPSettings : NSObject


+ (nonnull NSString *) getGPPString{
    NSString* gppString = [[NSUserDefaults standardUserDefaults] objectForKey:EPL_IABGPP_HDR_GppString];
...
+ (nonnull NSArray<NSNumber *> *) getGPPSIDArray{
    ...
    NSString* gppsidString = [[NSUserDefaults standardUserDefaults] objectForKey:EPL_IABGPP_GppSID];
